...
import com.smasher.zxing.camera.BitmapLuminanceSource;
import com.smasher.zxing.camera.CameraManager;
import com.smasher.zxing.decoding.DecodeFormatManager;
...
public class CodeUtils {
    ...
    public static void analyzeBitmap(String path, AnalyzeCallback analyzeCallback) {
        ...
        boolean empty = decodeFormats == null || decodeFormats.isEmpty();
        if (empty) {
